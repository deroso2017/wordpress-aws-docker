<?php
    ...
    add_action('init', function () {
        add_filter('colibri_theme_title_default_content', function($title) {
            $theme_click_pen_to_edit_title = __('Aspire. Build. Achieve.', 'peregrine');
        ...
        add_filter('colibri_theme_subtitle_default_content', function($subtitle) {
            return  __(
                'Lorem ipsum dolor sit amet, at mei dolore tritani.In his nemore temporibus consequuntur, vim ad prima vivendum consetetur.Viderer feugiat at pro, mea aperiam.',
                'peregrine'
            );
        });
    });
    ...
    $peregrine_theme_svg_icons = array(
		'fort-awesome'  => array(
	...
	$peregrine_theme_divider_style = array(
	...
	$peregrine_title = "Aspire. Build. Achieve.";
	$peregrine_lorem_ipsum = "Lorem ipsum dolor sit amet, at mei dolore tritani.In his nemore temporibus consequuntur, vim ad prima vivendum consetetur.Viderer feugiat at pro, mea aperiam.";;
	...
	return array(
		...
		"edit_this_text_in_customizer"      => $peregrine_title,
		'lorem_ipsum'                       => $peregrine_lorem_ipsum,
		...
		'blog_post_thumb_placeholder_color' => 'rgb(240, 240, 240)',
		'blog_post_excerpt_length'          => 13,
		'assets_js_key'                     => "peregrineFrontendData",

		'default_icon'                      => $peregrine_theme_svg_icons['fort-awesome'],
		'icons'                             => $peregrine_theme_svg_icons,
		'divider_style'                     => $peregrine_theme_divider_style,
		"gradients"                         => array(
			'night_fade'  =>
				array(
					'name'  => 'night_fade',
		...
		'header_front_page'                 => array(
			...
			"hero"         => array(
				...
				"props"             => array(
					"heroSection" => array(
						"layout" => "textOnly" // [textOnly, textWithMediaOnLeft, textWithMediaOnRight]
					),
				),
				"style"             => array(
					'padding'         =>
			...
			"social_icons" => array(
				...
				"localProps" => array(
					"icons" => json_encode( array(
						array(
							'icon'       => $peregrine_theme_svg_icons['facebook-2'],
							'link_value' => '#',
							'index'      => 0,
						),
						array(
							'icon'       => $peregrine_theme_svg_icons['twitter-x'],
							'link_value' => '#',
							'index'      => 1,
						),
						array(
							'icon'       => $peregrine_theme_svg_icons['instagram'],
							'link_value' => '#',
							'index'      => 2,
						),
						array(
							'icon'       => $peregrine_theme_svg_icons['youtube-play'],
							'link_value' => '#',
							'index'      => 3,
						),
					) ),
			...
			"icon_list"    => array(
				...
				"localProps" => array(
					"iconList" => json_encode( array(
						array(
							'icon'       => $peregrine_theme_svg_icons['map-marker-light'],
							'text'       => 'Location, State, Country',
							'link_value' => '#',
							'index'      => 0,
						),
						array(
							'icon'       => $peregrine_theme_svg_icons['phone-2'],
							'text'       => '(000) 123 12345',
							'link_value' => 'tel:00012312345',
							'index'      => 1,
						),
						array(
							'icon'       => $peregrine_theme_svg_icons['envelope-2'],
				...
				"style" => array(
					"background" => array(
						...
						"video" => array(
							...
							"poster"      => array(
								'url' => $theme_directory_uri . "/images/demo-video-cover.jpg"
							)
						),
						'overlay' => array(
							'type'  => 'color',
