 ...
 */
return array(
	'title'      => esc_html__( 'Post One Column', 'fse-gamer' ),
	'categories' => array( 'fse-gamer', 'Post One Column' ),
...
<!-- wp:post-title {"isLink":true,"style":{"typography":{"fontSize":"22px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontFamily":"fse-gamer-inter"} /-->

<!-- wp:post-excerpt {"excerptLength":20,"style":{"elements":{"link":{"color":{"text":"#747474"}}},"color":{"text":"#747474"},"typography":{"fontSize":"16px"}},"fontFamily":"fse-gamer-inter"} /-->
