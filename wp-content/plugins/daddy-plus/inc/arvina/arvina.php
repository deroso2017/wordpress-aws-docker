...
if ( ! function_exists( 'daddy_plus_abiz_frontpage_sections' ) ) :
	function daddy_plus_abiz_frontpage_sections() {
		require daddy_plus_plugin_dir . 'inc/arvina/frontpage/daddy-plus-index-slider.php';
		require daddy_plus_plugin_dir . 'inc/arvina/frontpage/daddy-plus-index-information.php';
