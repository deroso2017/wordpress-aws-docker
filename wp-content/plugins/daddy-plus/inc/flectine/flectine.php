...
require daddy_plus_plugin_dir . 'inc/flectine/frontpage/daddy-plus-main-header.php';
...
if ( ! function_exists( 'daddy_plus_flixita_frontpage_sections' ) ) :
	function daddy_plus_flixita_frontpage_sections() {
		...
		require daddy_plus_plugin_dir . 'inc/flectine/frontpage/daddy-plus-index-information.php';
		require daddy_plus_plugin_dir . 'inc/avire/frontpage/daddy-plus-index-marque.php';
		require daddy_plus_plugin_dir . 'inc/flectine/frontpage/daddy-plus-index-service.php';
