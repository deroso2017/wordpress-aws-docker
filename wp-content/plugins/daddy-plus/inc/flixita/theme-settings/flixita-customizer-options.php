...
function daddy_plus_flixita_customize_options($wp_customize)
{
	...
	if ( 'Avire' == $activate_theme || 'Flecto' == $activate_theme  || 'Alvert' == $activate_theme  || 'Avinza' == $activate_theme || 'Flectine' == $activate_theme  || 'Flixona' == $activate_theme  || 'Zestify' == $activate_theme) {
