...
if ( ! function_exists( 'daddy_plus_flixita_frontpage_sections' ) ) :
	function daddy_plus_flixita_frontpage_sections() {
		require daddy_plus_plugin_dir . 'inc/flixona/frontpage/daddy-plus-index-slider.php';
		require daddy_plus_plugin_dir . 'inc/flixona/frontpage/daddy-plus-index-information.php';
		require daddy_plus_plugin_dir . 'inc/avire/frontpage/daddy-plus-index-marque.php';
		require daddy_plus_plugin_dir . 'inc/flixona/frontpage/daddy-plus-index-service.php';
