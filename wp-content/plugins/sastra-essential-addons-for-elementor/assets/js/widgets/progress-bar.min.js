(function($){"use strict";const widgetProgressBar=function($scope,$){var $progressBar=$scope.find('.tmpcoder-progress-bar'),prBarCircle=$scope.find('.tmpcoder-prbar-circle'),$prBarCircleSvg=prBarCircle.find('.tmpcoder-prbar-circle-svg'),$prBarCircleLine=$prBarCircleSvg.find('.tmpcoder-prbar-circle-line'),$prBarCirclePrline=$scope.find('.tmpcoder-prbar-circle-prline'),prBarHrLine=$progressBar.find('.tmpcoder-prbar-hr-line-inner'),prBarVrLine=$progressBar.find('.tmpcoder-prbar-vr-line-inner'),prBarOptions=$progressBar.data('options'),prBarCircleOptions=prBarCircle.data('circle-options'),prBarCounter=$progressBar.find('.tmpcoder-prbar-counter-value'),prBarCounterValue=prBarOptions.counterValue,prBarCounterValuePersent=prBarOptions.counterValuePersent,prBarAnimDuration=prBarOptions.animDuration,prBarAnimDelay=prBarOptions.animDelay,prBarLoopDelay=+prBarOptions.loopDelay,currentDeviceMode=elementorFrontend.getCurrentDeviceMode(),numeratorData={toValue:prBarCounterValue,duration:prBarAnimDuration,};if('yes'===prBarOptions.counterSeparator){numeratorData.delimiter=','}
...
$(window).on('scroll',function(){progressBar()})}
$(window).on('elementor/frontend/init',function(){elementorFrontend.hooks.addAction('frontend/element_ready/tmpcoder-progress-bar.default',widgetProgressBar)})})(jQuery)