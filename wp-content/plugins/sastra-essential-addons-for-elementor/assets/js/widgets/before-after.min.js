...
hideLabelsOnTouch()})}
if('mouse'===imagesWrap.attr('data-trigger')){imagesWrap.on('mousemove',function(event){if(imagesWrap.hasClass('tmpcoder-ba-horizontal')){var overlayWidth=event.pageX-$(this).offset().left;divider.css('left',overlayWidth);imageTwo.css('left',overlayWidth);imageTwo.find('img').css('right',overlayWidth)}else{var overlayWidth=event.pageY-$(this).offset().top;divider.css('top',overlayWidth);imageTwo.css('top',overlayWidth);imageTwo.find('img').css('bottom',overlayWidth)}
hideLabelsOnTouch()})}
hideLabelsOnTouch();function hideLabelsOnTouch(){var labelOne=imagesWrap.find('.tmpcoder-ba-label-1 div'),labelTwo=imagesWrap.find('.tmpcoder-ba-label-2 div');if(!labelOne.length&&!labelTwo.length){return}
if(imagesWrap.hasClass('tmpcoder-ba-horizontal')){var labelOneOffset=labelOne.position().left+labelOne.outerWidth(),labelTwoOffset=labelTwo.position().left+labelTwo.outerWidth();if(labelOneOffset+15>=parseInt(divider.css('left'),10)){labelOne.stop().css('opacity',0)}else{labelOne.stop().css('opacity',1)}
...
if((imagesWrap.outerHeight()-(labelTwoOffset+15))<=parseInt(divider.css('top'),10)){labelTwo.stop().css('opacity',0)}else{labelTwo.stop().css('opacity',1)}}}}
$(window).on('elementor/frontend/init',function(){elementorFrontend.hooks.addAction("frontend/element_ready/tmpcoder-before-after.default",widgetBeforeAfter)})})(jQuery)