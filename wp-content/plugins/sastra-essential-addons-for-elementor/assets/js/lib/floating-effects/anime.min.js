...
return e?g:function(){var e=r.springs[n];if(e)return e;for(var t=0,a=0;;)
...
return function(t,r,a,i){if(0<=t&&t<=1&&0<=a&&a<=1){var c=new Float32Array(n);if(t!==r||a!==i)
...
if(o in n){var u=n[o];e.call(r,u,o,n)&&a.push(u)}return a}
...
function B(n){var e=M.duration,t=M.delay,l=e-M.endDelay,d=O(n);M.progress=a(d/e*100,0,100),M.reversePlayback=d<M.currentTime,r&&function(n){if(M.reversePlayback)
